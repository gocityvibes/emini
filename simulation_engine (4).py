...
class SimulationEngine:
    ...
    async def _process_snapshot(
        ...
        if hybrid_enabled:
            try:
                prefilter_result = score_setup(cleaned_snapshot, profile_id)
        ...
        try:
            ...
            decision = get_trade_decision(cleaned_snapshot, constraints, profile_id, MODEL_NAME)
            
            # Log the decision
            decision_id = log_decision(clean_for_ai({
                "symbol": symbol,
                "snapshot_id": snapshot_id,
                "snapshot_hash": snapshot_hash,
                "profile_id": profile_id,
